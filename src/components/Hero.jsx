...
const HERO_IMAGE =
  'https://images.pexels.com/photos/18848085/pexels-photo-18848085.jpeg?auto=compress&cs=tinysrgb&w=1200'

const FLOATING = [
  { label: 'Digital Marketing', pos: 'left-0 top-[18%] md:left-[-6%]', delay: '0s' },
  { label: 'Web Development', pos: 'right-0 top-[34%] md:right-[-8%]', delay: '1.5s' },
  { label: 'Graphic Design', pos: 'left-0 bottom-[14%] md:left-[-4%]', delay: '3s' },
  { label: 'Business Analysis', pos: 'right-0 bottom-[8%] md:right-[-6%]', delay: '4.5s' },
]
      ...
      <div className="relative mx-auto grid max-w-[1440px] grid-cols-1 items-center gap-12 px-[clamp(1.25rem,5vw,5rem)] pb-20 lg:grid-cols-12 lg:gap-8">
        ...
        <div className="lg:col-span-7">
          ...
          <p className="reveal mt-8 max-w-xl text-base leading-relaxed text-secondary md:text-lg">
            Hi, I&rsquo;m Mohammad Muzaif — a creative Digital Marketer focused on
            building brands, creating engaging digital experiences, and driving
            measurable growth.
          </p>

          <div className="reveal mt-10 flex flex-wrap items-center gap-4">
            <Button variant="primary" onClick={scrollToWork} magnetic>
              View My Work
            ...
            <Button variant="secondary" onClick={scrollToContact} magnetic>
              Let&rsquo;s Connect
            </Button>
